...
enum StuScoreList implements InputModule, CountModule, PrintModule {
    ...
    public void insert() {
        log.info("输入模块的insert()方法被调用！");
    }
    public void delete() {
        log.info("输入模块的delete()方法被调用！");
    }
    public void modify() {
        log.info("输入模块的modify()方法被调用！");
    }
    public void countTotalScore() {
        log.info("统计模块的countTotalScore()方法被调用！");
    }
    public void countAverage() {
        log.info("统计模块的countAverage()方法被调用！");
    }
    public void printStuInfo() {
        log.info("打印模块的printStuInfo()方法被调用！");
    }
    public void queryStuInfo() {
        log.info("打印模块的queryStuInfo()方法被调用！");
    }
}
